...
@section('content')
    <div class="mt-4 position-relative">
        <button type="button" data-bs-toggle="modal" data-bs-target="#newMessageModal"
            class="mt-2 p-2 btn btn-primary position-absolute" id="new-msg" style="right:0;">New message</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="input-group flex-nowrap">
                        ...
                        <input type="text" id="needle" name="needle" class="form-control" autocomplete="off"
                            placeholder="Start typing username..." aria-label="Username" aria-describedby="addon-wrapping">
                    </div>
