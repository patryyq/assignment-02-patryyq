...
<form action="{{ route('posts.update', $post->id) }}" method="POST">
    ...
    <div class="p-4 my-5 form-group bg-light border">
        ...
        <textarea class="form-control form-control-lg my-3 p-2 bg-gray-200 @error('comments') is-invalid @enderror" name="post_content" id="post_content" row="7">{{ $post->post_content }}</textarea>
