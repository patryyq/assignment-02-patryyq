...
<div>
    ...
    <form action="/posts" method="POST">
        ...
        <div class="p-4 mb-5 form-group bg-light border">
            ...
            <textarea placeholder="Type something to the world..." name="post_content" id="post_content" row="7" class="form-control form-control-lg my-3 p-2 bg-gray-200 @error('comments') is-invalid @enderror"></textarea>
