...
<form action="{{ route('comment.update', $comment->id) }}" method="POST">
    ...
    <div class="p-4 my-5 form-group bg-light border">
        ...
        <textarea class="form-control form-control-lg my-3 p-2 bg-gray-200 @error('comments') is-invalid @enderror" name="comment_content" id="comment_content" row="7">{{ $comment->comment_content }}</textarea>
